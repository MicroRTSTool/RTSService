...
public class ServiceDependencyMapper {
    ...
    public static String getDDG(String serviceName, String monitoringSvcUrl) throws Exception {
     ...
     * @return
     */
    public static Map<String, Set<String>> getMapOfAffectedServices(Map<String, Set<String>> serviceDependencies) {
    ...
    static void findAffectedServices(String service, Map<String, Set<String>> serviceDependencies, Set<String> affected) {
